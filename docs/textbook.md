...
> ⚠️ **2026-07-21 追記**: 本書は commit 9a90cf5 時点のスナップショットであり、凍結扱い。
> その後 PR #11（2a35ce9）で persist 規律（C1/C2/C4）が修正されるなど、安全性関連の
> 記述には古くなったものがある。**最新の問題ステータスは必ずリポジトリ直下の
> KNOWN_ISSUES.md を参照すること。** また本書が指摘した「ドキュメント 3 世代混在」は
