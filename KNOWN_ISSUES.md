...
| 状態 | 件数 |
|---|---|
| ✅ FIXED | 37（A1–A8, B1, B2, B3, C1, C2, C3, C4, D1, D2, D3, D4, D5, E1, E2, R1, R2, R3, R4, R5, R6, R9, R10, R11, R12, R13, R14, R15, R17, R19） |
| 🟠 PARTIAL | 0 |
| ❌ UNFIXED | 3（グループ R: R16, R18, R20） |
...
ただし learner（追いつき段階）は未実装（R20）で、R16・R18 も未修正のまま残るため、
「安全性違反なし」とは言えない。
...
10. R16、R18（設定、examples、benchmark）、R20（learner／non-voting member）
